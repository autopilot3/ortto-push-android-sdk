...
Prerequisites: Android Studio with JDK 17, Android SDK 36, an Ortto FCM app key, and a Firebase Android app registered for `com.ortto.demo`.
...
```sh
VERSION_NAME=1.8.9 ./gradlew :demo:installDebug
...
```sh
VERSION_NAME=1.8.9 ./gradlew :demo:testDebugUnitTest :demo:lintDebug :demo:assembleDebug
VERSION_NAME=1.8.9 ./gradlew :demo:connectedDebugAndroidTest
```
